...
export function Experience() {
  ...
  return (
    <section id="experience" className="py-24 px-6 md:px-12 max-w-7xl mx-auto border-t border-white/5 relative">
          ...
          {activeTab === 'experience' && hasExperience && (
            ...
            >
              {experiences.map((exp, idx) => (
                <motion.div 
                  key={exp.id}
                  initial={{ opacity: 0, x: idx % 2 === 0 ? -40 : 40, y: 15 }}
                ...
                >
                  ...
                  <div className="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] bg-white/5 border border-white/10 p-6 md:p-8 rounded-3xl group-hover:border-theme-p-500/50 transition-colors relative overflow-hidden">
