  ...
  return (
    <section id="projects" className="py-24 relative">
      <div className="max-w-7xl mx-auto px-6">
        <SectionHeading title="Featured Deployments" subtitle="A showcase of recent projects highlighting my expertise." />
        
        <div className="mb-16 flex flex-col md:flex-row gap-6 items-start md:items-center justify-between bg-[#0A0A0C] border border-white/5 p-6 rounded-3xl shadow-xl relative z-10">
              ...
              filteredProjects.map((project, index) => (
                ...
                >
                  ...
                  <div className="w-full lg:w-1/2 flex flex-col justify-center">
                    ...
                    <div className="bg-[#0A0A0C]/80 backdrop-blur-md border border-white/10 p-5 sm:p-6 rounded-3xl mb-6 relative z-20 -ml-0 lg:-ml-12 lg:mr-0 hover:border-theme-p-500/50 transition-colors shadow-2xl">
