  ...
  return (
    <section id="testimonials" className="py-24 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6">
        <SectionHeading title="Validation" subtitle="What people are saying about my work." />
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {testimonials.map((testimonial, index) => (
            <motion.div
              ...
              className="bg-gradient-to-br from-theme-p-500/10 to-transparent border border-white/5 p-8 rounded-3xl relative flex flex-col h-full"
            >
