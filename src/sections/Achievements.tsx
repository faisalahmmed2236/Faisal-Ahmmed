  ...
  return (
    <section id="achievements" className="py-24 relative bg-black/20">
      <div className="max-w-4xl mx-auto px-6">
        <SectionHeading title="Career Milestones" subtitle="Key accomplishments throughout my career journey." />
        ...
        <div className="space-y-6 relative before:absolute before:inset-0 before:ml-5 before:-translate-x-px md:before:mx-auto md:before:translate-x-0 before:h-full before:w-0.5 before:bg-gradient-to-b before:from-transparent before:via-white/10 before:to-transparent">
          {achievements.map((achievement, index) => (
            ...
            >
              ...
              <div className="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] bg-white/5 border border-white/5 p-6 rounded-3xl group-hover:border-theme-p-500/50 transition-colors">
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-2">
                  <h4 className="font-bold text-white text-lg">{achievement.title}</h4>
                  <time className="text-theme-p-400 text-sm font-mono">{achievement.year}</time>
                </div>
